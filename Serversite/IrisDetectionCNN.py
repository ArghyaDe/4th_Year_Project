...
IrisImage=np.load('F:\\Python_projects\\IrisKerasImage_data.npy',allow_pickle=True, fix_imports=True)
Label=np.load('F:\\Python_projects\\IrisKeraslable_data.npy',allow_pickle=True, fix_imports=True)
